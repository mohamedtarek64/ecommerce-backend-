...
// User profile routes - Protected with Sanctum
...
// Orders routes - Protected with Sanctum
...
// Categories and Brands routes (public)
...
// Product routes (public) with rate limiting
Route::middleware('throttle:api')->group(function () {
    Route::get('/products', [App\Http\Controllers\Api\ProductController::class, 'index']);
    Route::get('/products/search', [App\Http\Controllers\SearchController::class, 'search']);
